...
'''
This file was reprinted here because there is a small bug in the gaussian filter.
It doesn't accept tensors for shape and sigma by default. However, this is a must
when building an image augmentation pipeline with random blurring.
'''
